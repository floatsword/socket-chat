...
module.exports = {
  // service port
  port: options.prot || env.Port || 1103,

  // mongodb address
  database: options.database || env.Database || 'mongodb://localhost:27017/float',

  // jwt encryption secret
  jwtSecret: options.jwtSecret || env.JwtSecret || 'jwtSecret',

  // Maxmize the number of groups
  maxGroupsCount: 3, // TODO: unknown
